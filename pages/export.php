...
$formElements = [];
$n = [];
$n['field'] = '<button class="btn btn-save" type="submit" name="export" value="1">'.$this->i18n('contentmigrator_btn_export').'</button>';
$formElements[] = $n;
...
$fragment->setVar('title', $this->i18n('contentmigrator_title_export'), false);
